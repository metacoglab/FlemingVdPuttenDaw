# Wrapper for sourcing STAN utilities
source('~/Dropbox/Utils/stan/diagnoseMCMC.R')

# Functions extracted from Kruschke DBDA2 utilities reprinted here to avoid STAN/JAGS conflict errors
