...
dataset = readline(prompt = "Dataset? 2=behav, 3=fmri ")
...
stargazer(accModel, star.cutoffs = c(0.05, 0.01, 0.001), keep.stat = c("n"), covariate.labels = c("pre-decision coherence"))
